...
import { parse, H1, H2, H3, P, Container, Link, Button, ButtonLink, ButtonAnchor, Image } from '../components/Styled'
...
class IndexPage extends React.Component {
  ...
  render() {
    ...
    // About
    Sections.push( <About key="about" scheme="paleGreen" className={this.state.showAbout ? '' : 'hidden'}>
